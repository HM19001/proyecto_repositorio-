...
public class fusuario {
 ...
 //   private ConexionConBaseDatos mysql = new conexion();
    ...
    public DefaultTableModel mostrar_inicial() {
        ...
        String[] titulos = {"id", "usuario", "pasword", "tipo", "nombres", "apellidos", "dui", "Teléfono"};
        ...
        sSQL = "select p.id,p.usuario,p.pasword,p.tipo,p.nombres,p.apellidos,"
                + "p.dui,p.telefono from usuario p";
    ...
    public boolean insertar(vusuario dts) {
        cn= ConexionConBaseDatos.getConexion();
       sSQL = "insert into usuario (id,usuario,pasword,tipo,nombres,apellidos,dui,telefono)"
                + "values (?,?,?,?,?,?,?,?)";
   //     sSQL2 = "insert into usuario (id,usuario,pasword,tipo,nombres,apellidos,dui,telefono)"
     //           + "values (?,?,?,?,?,?,?,?)";
        try {
...
//consultar editar usuario
        ...
        sSQL2 = "update usuario set id=?,usuario=?,pasword=?,tipo=?,nombres=?,apellidos=?,dui=?,telefono=?"
                + " where id=?";
        try {
...
//consulta eliminar usuario
    ...
    public DefaultTableModel login(String usuario,String pasword) {
        ...
        String[] titulos = {"id", "usuario", "pasword", "tipo", "nombres", "apellidos", "dui", "telefono"};
        ...
        sSQL = "select p.id,p.usuario,p.pasword,p.tipo,"
                + "p.nombres,p.apellidos,p.dui,p.telefono from usuario p "
                + " where p.usuario='"
