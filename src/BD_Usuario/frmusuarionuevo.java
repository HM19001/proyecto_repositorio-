...
public class frmusuarionuevo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_dui.setForeground(new java.awt.Color(153, 143, 143));
        txt_dui.setText("Dui");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txt_dui, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(28, 28, 28)
...
if(txt_nombres.getText().length() == 0 ||  txt_apellidos.getText().length() == 0 || txt_usuario.getText().length() ==0 || txt_pasword.getText().length() == 0 || txt_dui.getText().length() == 0 || txt_telefono.getText().length() == 0){
    ...
    vusuario dts = new vusuario();
        ...
        dts.setdui(Integer.parseInt(txt_dui.getText()));
