...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-06-2022 a las 05:09:02
...
--
-- Base de datos: `basededatosferreteria`
--
...
(1, 'maria', 'se fue', 'ingenierievolucion', '6541654984894', 'querer es poder ', '78542564', 'sefuemaria@gmail.com'),
(2, 'fernando', 'guerra', 'computersv', '1654564548/42', 'carretera', '25486512', 'Fguerra@gmail.com'),
(3, 'perez', 'landaverde', 'dlc', '874897984', 'avenida', '85452698', 'landaverde@gmail.com'),
(4, 'doncheto', 'fuentes ', 'elbuenqueso', '561854984894', 'restaurante', '65465464', 'elcheto@gmail.com'),
(5, 'mateo', 'linares', 'trabajoues', '1452689775', 'el milagro', '54856231', 'linaresmateo'),
(6, '', '', '', '', '', '', ''),
(7, 'funciona?', 'prueba', 'dfgr', '6546541', 'dfgdf', '54984984', 'funciona@Gmail,com');
...
INSERT INTO `usuario` (`id`, `usuario`, `pasword`, `tipo`, `nombres`, `apellidos`, `dui`, `telefono`) VALUES
(1, 'admin', 'admin', 'Administrador', 'Bryan', 'Hernández ', 1541654856, 25458575),
(2, 'ues', '123', 'Empleado', 'ues', 'la ues ', 0, 932341223);
...
--
ALTER TABLE `table_facturas`
  MODIFY `No_Facturas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
